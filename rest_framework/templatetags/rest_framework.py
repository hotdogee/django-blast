...
from rest_framework.reverse import reverse # hotdogee
...
def optional_login(request):
    ...
    """
    try:
        login_url = reverse('rest_framework:login', request=request) # hotdogee
...
def optional_logout(request):
    ...
    """
    try:
        logout_url = reverse('rest_framework:logout', request=request) # hotdogee
    except NoReverseMatch:
        return ''
