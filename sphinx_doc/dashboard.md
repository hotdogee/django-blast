...
- **Password**: A secret string that conforms to the site password rules, which the site authentication system stores as a hashed digest.
...
- **Creds**: A *User*'s credentials, i.e., their *User Id* and *Password* stored in the site authentication system.
...
<center>Home Page/Guest Dashboard</center>
...
## Guest Access <a name="GuestAccess"></a>

- TBD

## User Access <a name="UserAccess"></a>
...
Flow diagram shows the interactions between the browser (User), the Dashboard, and the Authentication Subsystem. 
