...
A list of key points on usability from several references, mostly notes from a corporateo
course attended years ago. 

This may help craft a usability standard for our dashboard/website, to help with decision
involving layout, navigation, look and feel. 

Please feel free to critique it so I an amend it and we can share a common set of guidelines. 
...
The Average User's motto is:  ***DON'T MAKE ME THINK***
...
A bit like the dog-owner admonishing Spot to leave the garbage can alone; the dog only hears: 
blah, blah, blah, Spot, blah, blah, blah, Spot, blah.  
