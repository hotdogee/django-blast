    ...
    var $results_table = $('#results-table').dataTable({
        ...
        rowCallback: function (row, data) {
            if (data[index_of_jbrowse] != '') {
                ...
                //http://gmod-dev.nal.usda.gov:8080/anogla/jbrowse/?loc=Scaffold1:134095..135719&addStores={"url":{"type":"JBrowse/Store/SeqFeature/GFF3","urlTemplate":"http://gmod-dev.nal.usda.gov/media/07b73d9a3dde4eac9faa9c4109f7cfb6/Agla_Btl03082013.genome_new_ids.fa.gff"}}&addTracks=[{"label":"BlastResults","category":"0. Reference Assembly","type":"JBrowse/View/Track/HTMLFeatures","style": {"renderClassName":"blast-hit-20pct"},"store":"url"}]
            }
        }
    });
