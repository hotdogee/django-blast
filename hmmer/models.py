...
from blast.models import Organism, OrganismManager
...
class HmmerDB(models.Model):
    ...
    fasta_file = FileBrowseField('FASTA file path', max_length=100, directory='blast/db/', extensions='FASTA', format='FASTA', default='')
